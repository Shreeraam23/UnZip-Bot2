...
async def start(client, message):
    ...
    [
        [
            InlineKeyboardButton("📍 Update Channel", url="https://t.me/myserver23"),
        ],
        [
            InlineKeyboardButton("👥 Support Group", url="https://t.me/myservergroup23"),
            InlineKeyboardButton("👩‍💻 Developer", url="https://t.me/myserver23"),
        ] 
   ]
  )
    start_message = (
